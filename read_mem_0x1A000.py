...
def main():
    ...
    start_address = 0x0001a000
    end_address = 0x0001bfff

    for address in range(start_address, end_address + 1, 0x80):  # Increment by 0x80 
        time.sleep(0.1)
        ...
        data = [0x07, 0x23, 0x14, byte3, byte2, byte1, byte0, 0x80] 
